...
var Addresses = {
    ...
    addAddress: function (Address, callback){
        return db.query("insert into addresses(address, number, neighborhood, cep, reference_point) values(?,?,?,?,?)", 
            [Address.address, Address.number, Address.neighborhood, Address.cep, Address.reference_point], callback);
    },
    updateAddress: function (id, Address, callback){
        return db.query("update addresses set address=?, number=?, neighborhood=?, cep=?, reference_point=? where id=?", 
        [Address.address, Address.number, Address.neighborhood, Address.cep, Address.reference_point, id], callback);
    },
